...
# set up the window
WINDOWWIDTH = 800 # width and height of window
WINDOWHEIGHT = 800
...
player = pygame.Rect(300,100,56,56) # creates player rectangle
playerImage = pygame.image.load('PogU.png')
playerStretchedImage = pygame.transform.scale(playerImage, (56,56))
# stretches the image the more food you eat
foodImage = pygame.image.load('blob.gif')
foods = []
for i in range(20): # creates 20 food squares randomly splaced
    foods.append(pygame.Rect(random.randint(0, WINDOWWIDTH - 28),
                             random.randint(0, WINDOWHEIGHT - 28),
                             28, 28))
